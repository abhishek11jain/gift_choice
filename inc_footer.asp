                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            <div class="logo logo-width-1 wow fadeIn animated">
                                <a href="index.asp"><img src="assets/imgs/resources/gift-choice.png" alt="logo" class="img-fluid w-100"></a>
                            </div>
                    ...
                    <div class="col-lg-2 col-md-3">
                        ...
                        <ul class="footer-list wow fadeIn animated mb-sm-5 mb-md-0">
                            ...
                            <li><a href="about.asp">About Gift Choice</a></li>
                            <li><a href="shop_by_categories.asp">Shop By Category</a></li>
                    ...
                    <div class="col-lg-2  col-md-3">
                        ...
                        <ul class="footer-list wow fadeIn animated">
                            ...
                            <li><a href="terms_condition.asp">Terms &amp; Conditions</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-4 col-md-6">
